        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://www.instagram.com/melaimbala1/?hl=en" className="text-slate-300 hover:text-white transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/services" className="text-slate-300 hover:text-white transition-colors">Our Projects</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-slate-300">+44 7367 783732</span>
              </li>
              <li className="flex items-start">
                <Mail className="h-5 w-5 mr-2 mt-0.5 text-slate-400" />
                <span className="text-slate-300">Balamelaim@gmail.com</span>
              </li>
              <li className="flex items-start">
                <MapPin className="h-5 w-5 mr-2 mt-0.5 text-slate-400" />
                <span className="text-slate-300">Moorcroft Rd,
 B13 8LS
Birmingham</span>
              </li>
              <li className="flex items-start">
